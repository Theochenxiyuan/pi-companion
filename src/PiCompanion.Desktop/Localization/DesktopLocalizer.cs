...
internal static class DesktopLocalizer
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["选择模板后会填入草稿，不会立即运行"] = "Choosing a template fills the draft without running it",
        ["技能"] = "Skill",
        ...
        ["是否信任此工作区？"] = "Trust this workspace?",
        ["信任后，Pi 可以加载此工作区提供的项目设置、技能和系统提示。这些内容可能改变智能体的行为。"] = "Once trusted, Pi can load project settings, skills, and system prompts supplied by this workspace. These may change agent behavior.",
